...
In #link("https://yuan-ru-lin.github.io/posts/rosenbrock/")[the previous post], we saw how different optimizers performed on Rosenbrock function. It seems as long as we chose the right optimizer and the right initial point, we can always arrive the minimum point of the loss function and the story will turn out good.
...
#image("../static/regularization/overtraining.png")
...
#image("../static/regularization/regularization.png")
...
If the term is $L^2$-norm of the weights parameters, we call the minimization #strong[Ridge Regression]. If the term is $L^1$-norm instead, we call the minimization #strong[LASSO]. That is,
...
== Disclaimer
<disclaimer>
This is the second homework for the course #emph[Machine Learning and Manybody Physics] by Prof.~Ying-Jer Kao, National Taiwan University.
...
$ R^2 = 1 - frac(\(y_(p r e d) - y_(t r u e)\)^2, \(y_(t r u e) - chevron.l y_(t r u e) chevron.r\)^2) . $
...
#image("../static/regularization/index_15_1.png")
