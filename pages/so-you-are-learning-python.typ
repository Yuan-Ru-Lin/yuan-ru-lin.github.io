...
I developed a package called #link("https://github.com/Yuan-Ru-Lin/b2pandas")[`b2pandas`] that helps me deal with the analysis code that I used for my Master research.

I won't say I am over this Stage until I upload the package on PyPl#footnote[PyPl is like App Store for Python packages, but every package is free and open-source, which means you can contribute and use them almost all you want.]. In such way, one can say he/she is a part of the Python community and be confident on making this whole environment a better place.

= Summary
<summary>
If you still want to learn Python, here are some points that you may keep in mind when having this journey:

+ It's okay not to understand some concepts -- use them as if you knew it and someday you will.
+ Use the language whenever you find possible, even if it costs a bit more time.
+ Learn about refactor and unit testing when you find your codes hard to read.
