...
First, #link("https://daringfireball.net/projects/markdown/syntax")[Markdown] is a good thing to learn. It's simple and is supported by many editors, one of which may suit you.
...
- iA Writer for those who likes Bear but prefers one-time payment#footnote[Myself included.].

= On Notion
<on-notion>
I've noticed people start taking notes in Notion, which I had tried for several months before giving up. The blocks were cool and all, but I just want to flush out my thoughts and assign simple structure to them. No need for #emph[#strong[blocks within blocks within another giant block!]]

= Quick-and-Dirty Example for Markdown Syntax
<quick-and-dirty-example-for-markdown-syntax>
You may look at the source code of this article.#footnote[You can add images and tables; I rarely do that, though.]#footnote[If you want to convert your `.md` files into PDF, check out #link("https://pandoc.org")[pandoc].]
